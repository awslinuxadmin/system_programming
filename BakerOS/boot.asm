; This will run in REAL MODE - how all x86 compatible processors begin execution.

ORG 0x7c00          ;this tells NASM where in memory where the program will run/execute
